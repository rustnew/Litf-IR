...
impl QuantumGate {
    pub fn op_name(&self) -> &'static str {
        match self {
            ...
            Self::Z => "quantum.z",
            Self::S => "quantum.s",
            Self::Sdg => "quantum.sdg",
            Self::T => "quantum.t",
            Self::Tdg => "quantum.tdg",
            Self::SX => "quantum.sx",
            // 1-qubit parametric
            Self::RX => "quantum.rx",
            Self::RY => "quantum.ry",
            ...
            Self::U3 => "quantum.u3",
            // Fixed-angle
            Self::Rx90 => "quantum.rx90",
            Self::Rx180 => "quantum.rx180",
            // 2-qubit standard
            Self::CX => "quantum.cx",
            Self::CZ => "quantum.cz",
            Self::CY => "quantum.cy",
            Self::SWAP => "quantum.swap",
            Self::ISWAP => "quantum.iswap",
            Self::ECR => "quantum.ecr",
            Self::RZX => "quantum.rzx",
            Self::XX => "quantum.xx",
            Self::YY => "quantum.yy",
            Self::ZZ => "quantum.zz",
            // Rigetti
            Self::CPhase => "quantum.cphase",
            Self::XY => "quantum.xy",
            // Controlled phase
            Self::CP => "quantum.cp",
            // IonQ
            Self::GPI => "quantum.gpi",
            Self::GPI2 => "quantum.gpi2",
            Self::MS => "quantum.ms",
            // 3-qubit
            Self::CCX => "quantum.ccx",
            Self::CSWAP => "quantum.cswap",
            // Multi-controlled
            Self::MCX => "quantum.mcx",
            Self::MCZ => "quantum.mcz",
            // Special
    ...
    pub fn from_name(name: &str) -> Option<Self> {
        match name {
            "quantum.h" => Some(Self::H),
            "quantum.x" => Some(Self::X),
            "quantum.y" => Some(Self::Y),
            "quantum.z" => Some(Self::Z),
            "quantum.s" => Some(Self::S),
            "quantum.sdg" => Some(Self::Sdg),
            "quantum.t" => Some(Self::T),
            "quantum.tdg" => Some(Self::Tdg),
            "quantum.sx" => Some(Self::SX),
            "quantum.rx" => Some(Self::RX),
            "quantum.ry" => Some(Self::RY),
            "quantum.rz" => Some(Self::RZ),
            "quantum.p" => Some(Self::P),
            "quantum.u1" => Some(Self::U1),
            "quantum.u2" => Some(Self::U2),
            "quantum.u3" => Some(Self::U3),
            "quantum.rx90" => Some(Self::Rx90),
            "quantum.rx180" => Some(Self::Rx180),
            "quantum.cx" => Some(Self::CX),
            "quantum.cz" => Some(Self::CZ),
            "quantum.cy" => Some(Self::CY),
            "quantum.swap" => Some(Self::SWAP),
            "quantum.iswap" => Some(Self::ISWAP),
            "quantum.ecr" => Some(Self::ECR),
            "quantum.rzx" => Some(Self::RZX),
            "quantum.xx" => Some(Self::XX),
            "quantum.yy" => Some(Self::YY),
            "quantum.zz" => Some(Self::ZZ),
            "quantum.cphase" => Some(Self::CPhase),
            "quantum.xy" => Some(Self::XY),
            "quantum.cp" => Some(Self::CP),
            "quantum.gpi" => Some(Self::GPI),
            "quantum.gpi2" => Some(Self::GPI2),
            "quantum.ms" => Some(Self::MS),
            "quantum.ccx" => Some(Self::CCX),
            "quantum.cswap" => Some(Self::CSWAP),
            "quantum.mcx" => Some(Self::MCX),
            "quantum.mcz" => Some(Self::MCZ),
    ...
    pub fn native_basis(provider: Provider) -> &'static [QuantumGate] {
        match provider {
            ...
            Provider::Rigetti => &[Self::RZ, Self::RX, Self::CZ, Self::CPhase, Self::XY],
            Provider::IonQ => &[Self::GPI, Self::GPI2, Self::MS],
            Provider::Quantinuum => &[Self::RZ, Self::RX, Self::RY, Self::ZZ],
            Provider::Simulator => &[
                Self::H,
                Self::X,
                Self::Y,
